...
type BeaconBlockContainerV3 struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// Types that are assignable to Block:
	//
	//	*BeaconBlockContainerV3_Phase0Block
	//	*BeaconBlockContainerV3_AltairBlock
	//	*BeaconBlockContainerV3_BellatrixBlock
	//	*BeaconBlockContainerV3_BlindedBellatrixBlock
	//	*BeaconBlockContainerV3_CapellaBlock
	//	*BeaconBlockContainerV3_BlindedCapellaBlock
	//	*BeaconBlockContainerV3_DenebContents
	//	*BeaconBlockContainerV3_BlindedDenebContents
	Block isBeaconBlockContainerV3_Block `protobuf_oneof:"block"`
}

func (x *BeaconBlockContainerV3) Reset() {
	*x = BeaconBlockContainerV3{}
	if protoimpl.UnsafeEnabled {
...
func (x *BeaconBlockContainerV3) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BeaconBlockContainerV3) ProtoMessage() {}

func (x *BeaconBlockContainerV3) ProtoReflect() protoreflect.Message {
	mi := &file_proto_eth_v2_beacon_block_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BeaconBlockContainerV3.ProtoReflect.Descriptor instead.
func (*BeaconBlockContainerV3) Descriptor() ([]byte, []int) {
	return file_proto_eth_v2_beacon_block_proto_rawDescGZIP(), []int{4}
}

func (m *BeaconBlockContainerV3) GetBlock() isBeaconBlockContainerV3_Block {
	if m != nil {
		return m.Block
	}
	return nil
...
func (x *BeaconBlockContainerV3) GetPhase0Block() *v1.BeaconBlock {
	if x, ok := x.GetBlock().(*BeaconBlockContainerV3_Phase0Block); ok {
		return x.Phase0Block
	}
	return nil
}

func (x *BeaconBlockContainerV3) GetAltairBlock() *BeaconBlockAltair {
	if x, ok := x.GetBlock().(*BeaconBlockContainerV3_AltairBlock); ok {
		return x.AltairBlock
	}
	return nil
}

func (x *BeaconBlockContainerV3) GetBellatrixBlock() *BeaconBlockBellatrix {
	if x, ok := x.GetBlock().(*BeaconBlockContainerV3_BellatrixBlock); ok {
		return x.BellatrixBlock
	}
	return nil
}

func (x *BeaconBlockContainerV3) GetBlindedBellatrixBlock() *BlindedBeaconBlockBellatrix {
	if x, ok := x.GetBlock().(*BeaconBlockContainerV3_BlindedBellatrixBlock); ok {
		return x.BlindedBellatrixBlock
	}
	return nil
}

func (x *BeaconBlockContainerV3) GetCapellaBlock() *BeaconBlockCapella {
	if x, ok := x.GetBlock().(*BeaconBlockContainerV3_CapellaBlock); ok {
		return x.CapellaBlock
	}
	return nil
}

func (x *BeaconBlockContainerV3) GetBlindedCapellaBlock() *BlindedBeaconBlockCapella {
	if x, ok := x.GetBlock().(*BeaconBlockContainerV3_BlindedCapellaBlock); ok {
		return x.BlindedCapellaBlock
	}
	return nil
}

func (x *BeaconBlockContainerV3) GetDenebContents() *BeaconBlockContentsDeneb {
	if x, ok := x.GetBlock().(*BeaconBlockContainerV3_DenebContents); ok {
		return x.DenebContents
	}
	return nil
}

func (x *BeaconBlockContainerV3) GetBlindedDenebContents() *BlindedBeaconBlockContentsDeneb {
	if x, ok := x.GetBlock().(*BeaconBlockContainerV3_BlindedDenebContents); ok {
		return x.BlindedDenebContents
	}
	return nil
}

type isBeaconBlockContainerV3_Block interface {
	isBeaconBlockContainerV3_Block()
}

type BeaconBlockContainerV3_Phase0Block struct {
	Phase0Block *v1.BeaconBlock `protobuf:"bytes,1,opt,name=phase0_block,json=phase0Block,proto3,oneof"`
}

type BeaconBlockContainerV3_AltairBlock struct {
	AltairBlock *BeaconBlockAltair `protobuf:"bytes,2,opt,name=altair_block,json=altairBlock,proto3,oneof"`
}

type BeaconBlockContainerV3_BellatrixBlock struct {
	BellatrixBlock *BeaconBlockBellatrix `protobuf:"bytes,3,opt,name=bellatrix_block,json=bellatrixBlock,proto3,oneof"`
}

type BeaconBlockContainerV3_BlindedBellatrixBlock struct {
	BlindedBellatrixBlock *BlindedBeaconBlockBellatrix `protobuf:"bytes,4,opt,name=blinded_bellatrix_block,json=blindedBellatrixBlock,proto3,oneof"`
}

type BeaconBlockContainerV3_CapellaBlock struct {
	CapellaBlock *BeaconBlockCapella `protobuf:"bytes,5,opt,name=capella_block,json=capellaBlock,proto3,oneof"`
}

type BeaconBlockContainerV3_BlindedCapellaBlock struct {
	BlindedCapellaBlock *BlindedBeaconBlockCapella `protobuf:"bytes,6,opt,name=blinded_capella_block,json=blindedCapellaBlock,proto3,oneof"`
}

type BeaconBlockContainerV3_DenebContents struct {
	DenebContents *BeaconBlockContentsDeneb `protobuf:"bytes,7,opt,name=deneb_contents,json=denebContents,proto3,oneof"`
}

type BeaconBlockContainerV3_BlindedDenebContents struct {
	BlindedDenebContents *BlindedBeaconBlockContentsDeneb `protobuf:"bytes,8,opt,name=blinded_deneb_contents,json=blindedDenebContents,proto3,oneof"`
}

func (*BeaconBlockContainerV3_Phase0Block) isBeaconBlockContainerV3_Block() {}

func (*BeaconBlockContainerV3_AltairBlock) isBeaconBlockContainerV3_Block() {}

func (*BeaconBlockContainerV3_BellatrixBlock) isBeaconBlockContainerV3_Block() {}

func (*BeaconBlockContainerV3_BlindedBellatrixBlock) isBeaconBlockContainerV3_Block() {}

func (*BeaconBlockContainerV3_CapellaBlock) isBeaconBlockContainerV3_Block() {}

func (*BeaconBlockContainerV3_BlindedCapellaBlock) isBeaconBlockContainerV3_Block() {}

func (*BeaconBlockContainerV3_DenebContents) isBeaconBlockContainerV3_Block() {}

func (*BeaconBlockContainerV3_BlindedDenebContents) isBeaconBlockContainerV3_Block() {}
...
func (x *BlindedBeaconBlockContentsDeneb) Reset() {
	*x = BlindedBeaconBlockContentsDeneb{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_eth_v2_beacon_block_proto_msgTypes[34]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BlindedBeaconBlockContentsDeneb) Descriptor() ([]byte, []int) {
	return file_proto_eth_v2_beacon_block_proto_rawDescGZIP(), []int{34}
}
...
var file_proto_eth_v2_beacon_block_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x74, 0x73, 0x42, 0x07, 0x0a, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x22, 0xd3, 0x05,
	0x0a, 0x16, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x43, 0x6f, 0x6e,
	0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x56, 0x33, 0x12, 0x41, 0x0a, 0x0c, 0x70, 0x68, 0x61, 0x73,
	...
	0x78, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x66, 0x0a, 0x17, 0x62, 0x6c, 0x69, 0x6e, 0x64, 0
 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28,
	...
	,
...
var file_proto_eth_v2_beacon_block_proto_msgTypes = make([]protoimpl.MessageInfo, 35)
var file_proto_eth_v2_beacon_block_proto_goTypes = []interface{}{
	...
	(*BeaconBlockContainerV3)(nil),                    // 4: ethereum.eth.v2.BeaconBlockContainerV3
	(*SignedBeaconBlockContainer)(nil),                // 5: ethereum.eth.v2.SignedBeaconBlockContainer
	(*SignedBeaconBlockContentsContainer)(nil),        // 6: ethereum.eth.v2.SignedBeaconBlockContentsContainer
	(*BlindedBeaconBlockContainer)(nil),               // 7: ethereum.eth.v2.BlindedBeaconBlockContainer
	(*SignedBlindedBeaconBlockContainer)(nil),         // 8: ethereum.eth.v2.SignedBlindedBeaconBlockContainer
	(*SignedBlindedBeaconBlockContentsContainer)(nil), // 9: ethereum.eth.v2.SignedBlindedBeaconBlockContentsContainer
	(*SignedBeaconBlockAltair)(nil),                   // 10: ethereum.eth.v2.SignedBeaconBlockAltair
	(*SignedBeaconBlockBellatrix)(nil),                // 11: ethereum.eth.v2.SignedBeaconBlockBellatrix
	(*SignedBeaconBlockCapella)(nil),                  // 12: ethereum.eth.v2.SignedBeaconBlockCapella
	(*SignedBeaconBlockDeneb)(nil),                    // 13: ethereum.eth.v2.SignedBeaconBlockDeneb
	(*SignedBlindedBeaconBlockBellatrix)(nil),         // 14: ethereum.eth.v2.SignedBlindedBeaconBlockBellatrix
	(*SignedBlindedBeaconBlockCapella)(nil),           // 15: ethereum.eth.v2.SignedBlindedBeaconBlockCapella
	(*SignedBlindedBeaconBlockDeneb)(nil),             // 16: ethereum.eth.v2.SignedBlindedBeaconBlockDeneb
	(*BeaconBlockAltair)(nil),                         // 17: ethereum.eth.v2.BeaconBlockAltair
	(*BeaconBlockBellatrix)(nil),                      // 18: ethereum.eth.v2.BeaconBlockBellatrix
	(*BlindedBeaconBlockBellatrix)(nil),               // 19: ethereum.eth.v2.BlindedBeaconBlockBellatrix
	(*BeaconBlockCapella)(nil),                        // 20: ethereum.eth.v2.BeaconBlockCapella
	(*BlindedBeaconBlockCapella)(nil),                 // 21: ethereum.eth.v2.BlindedBeaconBlockCapella
	(*BeaconBlockDeneb)(nil),                          // 22: ethereum.eth.v2.BeaconBlockDeneb
	(*BlindedBeaconBlockDeneb)(nil),                   // 23: ethereum.eth.v2.BlindedBeaconBlockDeneb
	(*BeaconBlockBodyAltair)(nil),                     // 24: ethereum.eth.v2.BeaconBlockBodyAltair
	(*BeaconBlockBodyBellatrix)(nil),                  // 25: ethereum.eth.v2.BeaconBlockBodyBellatrix
	(*BlindedBeaconBlockBodyBellatrix)(nil),           // 26: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix
	(*BeaconBlockBodyCapella)(nil),                    // 27: ethereum.eth.v2.BeaconBlockBodyCapella
	(*BlindedBeaconBlockBodyCapella)(nil),             // 28: ethereum.eth.v2.BlindedBeaconBlockBodyCapella
	(*BlindedBeaconBlockBodyDeneb)(nil),               // 29: ethereum.eth.v2.BlindedBeaconBlockBodyDeneb
	(*BeaconBlockBodyDeneb)(nil),                      // 30: ethereum.eth.v2.BeaconBlockBodyDeneb
	(*SignedBeaconBlockContentsDeneb)(nil),            // 31: ethereum.eth.v2.SignedBeaconBlockContentsDeneb
	(*SignedBlindedBeaconBlockContentsDeneb)(nil),     // 32: ethereum.eth.v2.SignedBlindedBeaconBlockContentsDeneb
	(*BeaconBlockContentsDeneb)(nil),                  // 33: ethereum.eth.v2.BeaconBlockContentsDeneb
	(*BlindedBeaconBlockContentsDeneb)(nil),           // 34: ethereum.eth.v2.BlindedBeaconBlockContentsDeneb
	(Version)(0),                                      // 35: ethereum.eth.v2.Version
	(*v1.BeaconBlock)(nil),                            // 36: ethereum.eth.v1.BeaconBlock
	(*v1.SignedBeaconBlock)(nil),                      // 37: ethereum.eth.v1.SignedBeaconBlock
	(*v1.Eth1Data)(nil),                               // 38: ethereum.eth.v1.Eth1Data
	(*v1.ProposerSlashing)(nil),                       // 39: ethereum.eth.v1.ProposerSlashing
	(*v1.AttesterSlashing)(nil),                       // 40: ethereum.eth.v1.AttesterSlashing
	(*v1.Attestation)(nil),                            // 41: ethereum.eth.v1.Attestation
	(*v1.Deposit)(nil),                                // 42: ethereum.eth.v1.Deposit
	(*v1.SignedVoluntaryExit)(nil),                    // 43: ethereum.eth.v1.SignedVoluntaryExit
...
var file_proto_eth_v2_beacon_block_proto_depIdxs = []int32{
	35,  // 0: ethereum.eth.v2.BlockResponseV2.version:type_name -> ethereum.eth.v2.Version
	5,   // 1: ethereum.eth.v2.BlockResponseV2.data:type_name -> ethereum.eth.v2.SignedBeaconBlockContainer
	35,  // 2: ethereum.eth.v2.BlindedBlockResponse.version:type_name -> ethereum.eth.v2.Version
	8,   // 3: ethereum.eth.v2.BlindedBlockResponse.data:type_name -> ethereum.eth.v2.SignedBlindedBeaconBlockContainer
	36,  // 4: ethereum.eth.v2.BeaconBlockContainerV2.phase0_block:type_name -> ethereum.eth.v1.BeaconBlock
	17,  // 5: ethereum.eth.v2.BeaconBlockContainerV2.altair_block:type_name -> ethereum.eth.v2.BeaconBlockAltair
	18,  // 6: ethereum.eth.v2.BeaconBlockContainerV2.bellatrix_block:type_name -> ethereum.eth.v2.BeaconBlockBellatrix
	20,  // 7: ethereum.eth.v2.BeaconBlockContainerV2.capella_block:type_name -> ethereum.eth.v2.BeaconBlockCapella
	33,  // 8: ethereum.eth.v2.BeaconBlockContainerV2.deneb_contents:type_name -> ethereum.eth.v2.BeaconBlockContentsDeneb
	36,  // 9: ethereum.eth.v2.BeaconBlockContainerV3.phase0_block:type_name -> ethereum.eth.v1.BeaconBlock
	17,  // 10: ethereum.eth.v2.BeaconBlockContainerV3.altair_block:type_name -> ethereum.eth.v2.BeaconBlockAltair
	18,  // 11: ethereum.eth.v2.BeaconBlockContainerV3.bellatrix_block:type_name -> ethereum.eth.v2.BeaconBlockBellatrix
	19,  // 12: ethereum.eth.v2.BeaconBlockContainerV3.blinded_bellatrix_block:type_name -> ethereum.eth.v2.BlindedBeaconBlockBellatrix
	20,  // 13: ethereum.eth.v2.BeaconBlockContainerV3.capella_block:type_name -> ethereum.eth.v2.BeaconBlockCapella
	21,  // 14: ethereum.eth.v2.BeaconBlockContainerV3.blinded_capella_block:type_name -> ethereum.eth.v2.BlindedBeaconBlockCapella
	33,  // 15: ethereum.eth.v2.BeaconBlockContainerV3.deneb_contents:type_name -> ethereum.eth.v2.BeaconBlockContentsDeneb
	34,  // 16: ethereum.eth.v2.BeaconBlockContainerV3.blinded_deneb_contents:type_name -> ethereum.eth.v2.BlindedBeaconBlockContentsDeneb
	36,  // 17: ethereum.eth.v2.SignedBeaconBlockContainer.phase0_block:type_name -> ethereum.eth.v1.BeaconBlock
	17,  // 18: ethereum.eth.v2.SignedBeaconBlockContainer.altair_block:type_name -> ethereum.eth.v2.BeaconBlockAltair
	18,  // 19: ethereum.eth.v2.SignedBeaconBlockContainer.bellatrix_block:type_name -> ethereum.eth.v2.BeaconBlockBellatrix
	20,  // 20: ethereum.eth.v2.SignedBeaconBlockContainer.capella_block:type_name -> ethereum.eth.v2.BeaconBlockCapella
	22,  // 21: ethereum.eth.v2.SignedBeaconBlockContainer.deneb_block:type_name -> ethereum.eth.v2.BeaconBlockDeneb
	37,  // 22: ethereum.eth.v2.SignedBeaconBlockContentsContainer.phase0_block:type_name -> ethereum.eth.v1.SignedBeaconBlock
	10,  // 23: ethereum.eth.v2.SignedBeaconBlockContentsContainer.altair_block:type_name -> ethereum.eth.v2.SignedBeaconBlockAltair
	11,  // 24: ethereum.eth.v2.SignedBeaconBlockContentsContainer.bellatrix_block:type_name -> ethereum.eth.v2.SignedBeaconBlockBellatrix
	12,  // 25: ethereum.eth.v2.SignedBeaconBlockContentsContainer.capella_block:type_name -> ethereum.eth.v2.SignedBeaconBlockCapella
	31,  // 26: ethereum.eth.v2.SignedBeaconBlockContentsContainer.deneb_contents:type_name -> ethereum.eth.v2.SignedBeaconBlockContentsDeneb
	36,  // 27: ethereum.eth.v2.BlindedBeaconBlockContainer.phase0_block:type_name -> ethereum.eth.v1.BeaconBlock
	17,  // 28: ethereum.eth.v2.BlindedBeaconBlockContainer.altair_block:type_name -> ethereum.eth.v2.BeaconBlockAltair
	19,  // 29: ethereum.eth.v2.BlindedBeaconBlockContainer.bellatrix_block:type_name -> ethereum.eth.v2.BlindedBeaconBlockBellatrix
	21,  // 30: ethereum.eth.v2.BlindedBeaconBlockContainer.capella_block:type_name -> ethereum.eth.v2.BlindedBeaconBlockCapella
	34,  // 31: ethereum.eth.v2.BlindedBeaconBlockContainer.deneb_contents:type_name -> ethereum.eth.v2.BlindedBeaconBlockContentsDeneb
	36,  // 32: ethereum.eth.v2.SignedBlindedBeaconBlockContainer.phase0_block:type_name -> ethereum.eth.v1.BeaconBlock
	17,  // 33: ethereum.eth.v2.SignedBlindedBeaconBlockContainer.altair_block:type_name -> ethereum.eth.v2.BeaconBlockAltair
	19,  // 34: ethereum.eth.v2.SignedBlindedBeaconBlockContainer.bellatrix_block:type_name -> ethereum.eth.v2.BlindedBeaconBlockBellatrix
	21,  // 35: ethereum.eth.v2.SignedBlindedBeaconBlockContainer.capella_block:type_name -> ethereum.eth.v2.BlindedBeaconBlockCapella
	23,  // 36: ethereum.eth.v2.SignedBlindedBeaconBlockContainer.deneb_block:type_name -> ethereum.eth.v2.BlindedBeaconBlockDeneb
	37,  // 37: ethereum.eth.v2.SignedBlindedBeaconBlockContentsContainer.phase0_block:type_name -> ethereum.eth.v1.SignedBeaconBlock
	10,  // 38: ethereum.eth.v2.SignedBlindedBeaconBlockContentsContainer.altair_block:type_name -> ethereum.eth.v2.SignedBeaconBlockAltair
	14,  // 39: ethereum.eth.v2.SignedBlindedBeaconBlockContentsContainer.bellatrix_block:type_name -> ethereum.eth.v2.SignedBlindedBeaconBlockBellatrix
	15,  // 40: ethereum.eth.v2.SignedBlindedBeaconBlockContentsContainer.capella_block:type_name -> ethereum.eth.v2.SignedBlindedBeaconBlockCapella
	32,  // 41: ethereum.eth.v2.SignedBlindedBeaconBlockContentsContainer.deneb_contents:type_name -> ethereum.eth.v2.SignedBlindedBeaconBlockContentsDeneb
	17,  // 42: ethereum.eth.v2.SignedBeaconBlockAltair.message:type_name -> ethereum.eth.v2.BeaconBlockAltair
	18,  // 43: ethereum.eth.v2.SignedBeaconBlockBellatrix.message:type_name -> ethereum.eth.v2.BeaconBlockBellatrix
	20,  // 44: ethereum.eth.v2.SignedBeaconBlockCapella.message:type_name -> ethereum.eth.v2.BeaconBlockCapella
	22,  // 45: ethereum.eth.v2.SignedBeaconBlockDeneb.message:type_name -> ethereum.eth.v2.BeaconBlockDeneb
	19,  // 46: ethereum.eth.v2.SignedBlindedBeaconBlockBellatrix.message:type_name -> ethereum.eth.v2.BlindedBeaconBlockBellatrix
	21,  // 47: ethereum.eth.v2.SignedBlindedBeaconBlockCapella.message:type_name -> ethereum.eth.v2.BlindedBeaconBlockCapella
	23,  // 48: ethereum.eth.v2.SignedBlindedBeaconBlockDeneb.message:type_name -> ethereum.eth.v2.BlindedBeaconBlockDeneb
	24,  // 49: ethereum.eth.v2.BeaconBlockAltair.body:type_name -> ethereum.eth.v2.BeaconBlockBodyAltair
	25,  // 50: ethereum.eth.v2.BeaconBlockBellatrix.body:type_name -> ethereum.eth.v2.BeaconBlockBodyBellatrix
	26,  // 51: ethereum.eth.v2.BlindedBeaconBlockBellatrix.body:type_name -> ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix
	27,  // 52: ethereum.eth.v2.BeaconBlockCapella.body:type_name -> ethereum.eth.v2.BeaconBlockBodyCapella
	28,  // 53: ethereum.eth.v2.BlindedBeaconBlockCapella.body:type_name -> ethereum.eth.v2.BlindedBeaconBlockBodyCapella
	30,  // 54: ethereum.eth.v2.BeaconBlockDeneb.body:type_name -> ethereum.eth.v2.BeaconBlockBodyDeneb
	29,  // 55: ethereum.eth.v2.BlindedBeaconBlockDeneb.body:type_name -> ethereum.eth.v2.BlindedBeaconBlockBodyDeneb
	38,  // 56: ethereum.eth.v2.BeaconBlockBodyAltair.eth1_data:type_name -> ethereum.eth.v1.Eth1Data
	39,  // 57: ethereum.eth.v2.BeaconBlockBodyAltair.proposer_slashings:type_name -> ethereum.eth.v1.ProposerSlashing
	40,  // 58: ethereum.eth.v2.BeaconBlockBodyAltair.attester_slashings:type_name -> ethereum.eth.v1.AttesterSlashing
	41,  // 59: ethereum.eth.v2.BeaconBlockBodyAltair.attestations:type_name -> ethereum.eth.v1.Attestation
	42,  // 60: ethereum.eth.v2.BeaconBlockBodyAltair.deposits:type_name -> ethereum.eth.v1.Deposit
	43,  // 61: ethereum.eth.v2.BeaconBlockBodyAltair.voluntary_exits:type_name -> ethereum.eth.v1.SignedVoluntaryExit
	44,  // 62: ethereum.eth.v2.BeaconBlockBodyAltair.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
	38,  // 63: ethereum.eth.v2.BeaconBlockBodyBellatrix.eth1_data:type_name -> ethereum.eth.v1.Eth1Data
	39,  // 64: ethereum.eth.v2.BeaconBlockBodyBellatrix.proposer_slashings:type_name -> ethereum.eth.v1.ProposerSlashing
	40,  // 65: ethereum.eth.v2.BeaconBlockBodyBellatrix.attester_slashings:type_name -> ethereum.eth.v1.AttesterSlashing
	41,  // 66: ethereum.eth.v2.BeaconBlockBodyBellatrix.attestations:type_name -> ethereum.eth.v1.Attestation
	42,  // 67: ethereum.eth.v2.BeaconBlockBodyBellatrix.deposits:type_name -> ethereum.eth.v1.Deposit
	43,  // 68: ethereum.eth.v2.BeaconBlockBodyBellatrix.voluntary_exits:type_name -> ethereum.eth.v1.SignedVoluntaryExit
	44,  // 69: ethereum.eth.v2.BeaconBlockBodyBellatrix.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
	45,  // 70: ethereum.eth.v2.BeaconBlockBodyBellatrix.execution_payload:type_name -> ethereum.engine.v1.ExecutionPayload
	38,  // 71: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.eth1_data:type_name -> ethereum.eth.v1.Eth1Data
	39,  // 72: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.proposer_slashings:type_name -> ethereum.eth.v1.ProposerSlashing
	40,  // 73: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.attester_slashings:type_name -> ethereum.eth.v1.AttesterSlashing
	41,  // 74: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.attestations:type_name -> ethereum.eth.v1.Attestation
	42,  // 75: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.deposits:type_name -> ethereum.eth.v1.Deposit
	43,  // 76: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.voluntary_exits:type_name -> ethereum.eth.v1.SignedVoluntaryExit
	44,  // 77: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
	46,  // 78: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.execution_payload_header:type_name -> ethereum.engine.v1.ExecutionPayloadHeader
	38,  // 79: ethereum.eth.v2.BeaconBlockBodyCapella.eth1_data:type_name -> ethereum.eth.v1.Eth1Data
	39,  // 80: ethereum.eth.v2.BeaconBlockBodyCapella.proposer_slashings:type_name -> ethereum.eth.v1.ProposerSlashing
	40,  // 81: ethereum.eth.v2.BeaconBlockBodyCapella.attester_slashings:type_name -> ethereum.eth.v1.AttesterSlashing
	41,  // 82: ethereum.eth.v2.BeaconBlockBodyCapella.attestations:type_name -> ethereum.eth.v1.Attestation
	42,  // 83: ethereum.eth.v2.BeaconBlockBodyCapella.deposits:type_name -> ethereum.eth.v1.Deposit
	43,  // 84: ethereum.eth.v2.BeaconBlockBodyCapella.voluntary_exits:type_name -> ethereum.eth.v1.SignedVoluntaryExit
	44,  // 85: ethereum.eth.v2.BeaconBlockBodyCapella.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
	47,  // 86: ethereum.eth.v2.BeaconBlockBodyCapella.execution_payload:type_name -> ethereum.engine.v1.ExecutionPayloadCapella
	48,  // 87: ethereum.eth.v2.BeaconBlockBodyCapella.bls_to_execution_changes:type_name -> ethereum.eth.v2.SignedBLSToExecutionChange
	38,  // 88: ethereum.eth.v2.BlindedBeaconBlockBodyCapella.eth1_data:type_name -> ethereum.eth.v1.Eth1Data
	39,  // 89: ethereum.eth.v2.BlindedBeaconBlockBodyCapella.proposer_slashings:type_name -> ethereum.eth.v1.ProposerSlashing
	40,  // 90: ethereum.eth.v2.BlindedBeaconBlockBodyCapella.attester_slashings:type_name -> ethereum.eth.v1.AttesterSlashing
	41,  // 91: ethereum.eth.v2.BlindedBeaconBlockBodyCapella.attestations:type_name -> ethereum.eth.v1.Attestation
	42,  // 92: ethereum.eth.v2.BlindedBeaconBlockBodyCapella.deposits:type_name -> ethereum.eth.v1.Deposit
	43,  // 93: ethereum.eth.v2.BlindedBeaconBlockBodyCapella.voluntary_exits:type_name -> ethereum.eth.v1.SignedVoluntaryExit
	44,  // 94: ethereum.eth.v2.BlindedBeaconBlockBodyCapella.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
	49,  // 95: ethereum.eth.v2.BlindedBeaconBlockBodyCapella.execution_payload_header:type_name -> ethereum.engine.v1.ExecutionPayloadHeaderCapella
	48,  // 96: ethereum.eth.v2.BlindedBeaconBlockBodyCapella.bls_to_execution_changes:type_name -> ethereum.eth.v2.SignedBLSToExecutionChange
	38,  // 97: ethereum.eth.v2.BlindedBeaconBlockBodyDeneb.eth1_data:type_name -> ethereum.eth.v1.Eth1Data
	39,  // 98: ethereum.eth.v2.BlindedBeaconBlockBodyDeneb.proposer_slashings:type_name -> ethereum.eth.v1.ProposerSlashing
	40,  // 99: ethereum.eth.v2.BlindedBeaconBlockBodyDeneb.attester_slashings:type_name -> ethereum.eth.v1.AttesterSlashing
	41,  // 100: ethereum.eth.v2.BlindedBeaconBlockBodyDeneb.attestations:type_name -> ethereum.eth.v1.Attestation
	42,  // 101: ethereum.eth.v2.BlindedBeaconBlockBodyDeneb.deposits:type_name -> ethereum.eth.v1.Deposit
	43,  // 102: ethereum.eth.v2.BlindedBeaconBlockBodyDeneb.voluntary_exits:type_name -> ethereum.eth.v1.SignedVoluntaryExit
	44,  // 103: ethereum.eth.v2.BlindedBeaconBlockBodyDeneb.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
	50,  // 104: ethereum.eth.v2.BlindedBeaconBlockBodyDeneb.execution_payload_header:type_name -> ethereum.engine.v1.ExecutionPayloadHeaderDeneb
	48,  // 105: ethereum.eth.v2.BlindedBeaconBlockBodyDeneb.bls_to_execution_changes:type_name -> ethereum.eth.v2.SignedBLSToExecutionChange
	38,  // 106: ethereum.eth.v2.BeaconBlockBodyDeneb.eth1_data:type_name -> ethereum.eth.v1.Eth1Data
	39,  // 107: ethereum.eth.v2.BeaconBlockBodyDeneb.proposer_slashings:type_name -> ethereum.eth.v1.ProposerSlashing
	40,  // 108: ethereum.eth.v2.BeaconBlockBodyDeneb.attester_slashings:type_name -> ethereum.eth.v1.AttesterSlashing
	41,  // 109: ethereum.eth.v2.BeaconBlockBodyDeneb.attestations:type_name -> ethereum.eth.v1.Attestation
	42,  // 110: ethereum.eth.v2.BeaconBlockBodyDeneb.deposits:type_name -> ethereum.eth.v1.Deposit
	43,  // 111: ethereum.eth.v2.BeaconBlockBodyDeneb.voluntary_exits:type_name -> ethereum.eth.v1.SignedVoluntaryExit
	44,  // 112: ethereum.eth.v2.BeaconBlockBodyDeneb.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
	51,  // 113: ethereum.eth.v2.BeaconBlockBodyDeneb.execution_payload:type_name -> ethereum.engine.v1.ExecutionPayloadDeneb
	48,  // 114: ethereum.eth.v2.BeaconBlockBodyDeneb.bls_to_execution_changes:type_name -> ethereum.eth.v2.SignedBLSToExecutionChange
	13,  // 115: ethereum.eth.v2.SignedBeaconBlockContentsDeneb.signed_block:type_name -> ethereum.eth.v2.SignedBeaconBlockDeneb
	52,  // 116: ethereum.eth.v2.SignedBeaconBlockContentsDeneb.signed_blob_sidecars:type_name -> ethereum.eth.v2.SignedBlobSidecar
	16,  // 117: ethereum.eth.v2.SignedBlindedBeaconBlockContentsDeneb.signed_blinded_block:type_name -> ethereum.eth.v2.SignedBlindedBeaconBlockDeneb
	53,  // 118: ethereum.eth.v2.SignedBlindedBeaconBlockContentsDeneb.signed_blinded_blob_sidecars:type_name -> ethereum.eth.v2.SignedBlindedBlobSidecar
	22,  // 119: ethereum.eth.v2.BeaconBlockContentsDeneb.block:type_name -> ethereum.eth.v2.BeaconBlockDeneb
	54,  // 120: ethereum.eth.v2.BeaconBlockContentsDeneb.blob_sidecars:type_name -> ethereum.eth.v2.BlobSidecar
	23,  // 121: ethereum.eth.v2.BlindedBeaconBlockContentsDeneb.blinded_block:type_name -> ethereum.eth.v2.BlindedBeaconBlockDeneb
	55,  // 122: ethereum.eth.v2.BlindedBeaconBlockContentsDeneb.blinded_blob_sidecars:type_name -> ethereum.eth.v2.BlindedBlobSidecar
...
func file_proto_eth_v2_beacon_block_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_eth_v2_beacon_block_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BeaconBlockContainerV3); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_eth_v2_beacon_block_proto_msgTypes[34].Exporter = func(v interface{}, i int) interface{} {
	...
	file_proto_eth_v2_beacon_block_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*BeaconBlockContainerV3_Phase0Block)(nil),
		(*BeaconBlockContainerV3_AltairBlock)(nil),
		(*BeaconBlockContainerV3_BellatrixBlock)(nil),
		(*BeaconBlockContainerV3_BlindedBellatrixBlock)(nil),
		(*BeaconBlockContainerV3_CapellaBlock)(nil),
		(*BeaconBlockContainerV3_BlindedCapellaBlock)(nil),
		(*BeaconBlockContainerV3_DenebContents)(nil),
		(*BeaconBlockContainerV3_BlindedDenebContents)(nil),
	}
	...
	file_proto_eth_v2_beacon_block_proto_msgTypes[9].OneofWrappers = []interface{}{
